-- Circle Deadlock 
--            T1									   T2
-- DT: Update CuaHang(TinhTrangCH)    |   TX:   UPDATE DonHang(TinhTrang, MaTaiXe) (Nhận đơn)
-- DT: Update DonHang(TinhTrangDH)    |   TX:   SELECT CuaHang(Xem thông tin, địa chỉ nhận đơn để giao,..)

--T1
use QLBH
GO

DROP PROC IF EXISTS DT_CapNhatCH_DonHang
GO
CREATE PROC DT_CapNhatCH_DonHang (@maDH char(8), @ma_chi_nhanh char(8), @tinhtrang_CH nvarchar(30), @tinhtrang_DH nvarchar(30))              
AS
